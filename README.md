# UI/UX Experiment 1 – E-Commerce Application Design
...
## User Flow
Home → Product Browsing → Cart → Payment
...
### Home Screen
![Home Screen](https://github.com/Namee2518/UI-UX/blob/main/Home.jpg?raw=true)
...
### Payment Screen
![Payment Screen](https://github.com/Namee2518/UI-UX/blob/main/payment.jpg?raw=true)
...
- User experience flow in e-commerce applications  
- High-fidelity design creation using Figma  
